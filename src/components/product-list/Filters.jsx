...
export const Filters = ({setFilters}) => {
  ...
  return (
    <div className="filters">
      ...
      <TextFilterInput placeholder="Search code" className="filters__input" inputName={'code'} filterType={'contains'} filterSetFunction={setFilterCode} onInput={handleFilterInput} />
      <TextFilterInput min={0} type="number" placeholder="Price from" className="filters__input" inputName={'price'} filterType={'>='} filterSetFunction={setFilterPriceFrom} onInput={handleFilterInput} />
      <TextFilterInput min={0} type="number" placeholder="Price to" className="filters__input" inputName={'price'} filterType={'<='} filterSetFunction={setFilterPriceTo} onInput={handleFilterInput} />
      <TextFilterInput min={0} type="number" placeholder="Cost from" className="filters__input" inputName={'cost'} filterType={'>='} filterSetFunction={setFilterCostFrom} onInput={handleFilterInput} />
      <TextFilterInput min={0} type="number" placeholder="Cost to" className="filters__input" inputName={'cost'} filterType={'<='} filterSetFunction={setFilterCostTo} onInput={handleFilterInput} />
